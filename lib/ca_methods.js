...
const MOCK_DEVICE_INFO = require('./mock.js').mockDeviceInfo;
...
exports.methods = {
    ...
    __ca_init__: function(cb) {
        ...
        this.scratch.snapshot = null; //too big to checkpoint or getState()
    ...
    __ca_pulse__: function(cb) {
        ...
        if (MOCK_ENABLED) {
            this.setDeviceInfo(MOCK_DEVICE_INFO, cb);
        } else {
            cb(null);
        }
    },
